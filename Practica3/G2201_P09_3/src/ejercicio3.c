 ...
 * 
 * @param num_item Indica que numero de item es
 * @return letra o numero producido
 */
 ...
 * @brief Main
 *
 * En este main se implementa el ejercicio del productor-consumidor. 
 * Para ello se emplea el uso de memoria compartida y semaforos para protegerla.
 * 
